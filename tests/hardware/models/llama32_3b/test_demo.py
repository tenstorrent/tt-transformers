...
import pytest
from examples.llama32_3b import benchmark as example
...
def test_llama32_3b(test_config, mesh_device, optimizations):
    try:
        example.run_llama32_3b(test_config=test_config, mesh_device=mesh_device, optimizations=optimizations)
    except example.UnsupportedConfiguration as error:
