...
import pytest
from examples.llama33_70b import benchmark as example
...
def test_llama33_70b(test_config, mesh_device, optimizations):
    try:
        example.run_llama33_70b(test_config=test_config, mesh_device=mesh_device, optimizations=optimizations)
    except example.UnsupportedConfiguration as error:
