...
import pytest
from examples.llama32_1b import benchmark as example
...
def test_llama32_1b(test_config, mesh_device, optimizations):
    try:
        example.run_llama32_1b(test_config=test_config, mesh_device=mesh_device, optimizations=optimizations)
    except example.UnsupportedConfiguration as error:
