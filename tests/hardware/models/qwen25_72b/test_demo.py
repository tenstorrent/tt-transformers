...
import pytest
from examples.qwen25_72b import benchmark as example
...
def test_qwen25_72b(test_config, mesh_device, optimizations):
    try:
        example.run_qwen25_72b(test_config=test_config, mesh_device=mesh_device, optimizations=optimizations)
    except example.UnsupportedConfiguration as error:
