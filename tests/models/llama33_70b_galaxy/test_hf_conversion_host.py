...
"""Host qualification of the Llama-3.3-70B Galaxy adaptor.
...
shape and the wrong numbers. The layout conversion and the Llama 3 scaled-RoPE
preparation therefore have to be confirmed *numerically* on host
...
from tt_transformers.models.llama33_70b_galaxy.model import LLAMA33_70B_GALAXY_HF_MODEL, parameters_from_hf_config
...
# =============================================================================
# RoPE: the highest-ranked risk in this conversion, checked on host
# =============================================================================
...
def test_permuted_q_with_interleaved_rope_equals_hf_rotary_on_hf_layout(small_llama):
    ...
    This is the pairing nothing had qualified before: attention was qualified
