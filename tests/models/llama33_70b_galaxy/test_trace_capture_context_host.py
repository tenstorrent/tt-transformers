...
"""Focused host test for the second common-runtime change Galaxy tracing needed.
...
and that abort inside a multi-sub-device program leaves the mesh un-drainable.
`load_sub_device_manager` also cannot be called
