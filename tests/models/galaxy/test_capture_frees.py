...
"""Host cover for the capture-phase free deferral that closes F-1.
...
(`tttv2_milestone_c_evidence/trace/logs/j1_L80_true_eager_baseline.log`,
`b6_L80_release_non_persistent.log`).
