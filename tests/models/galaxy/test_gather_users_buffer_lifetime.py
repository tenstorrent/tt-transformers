...
it (`logs/host_new_tests_without_fix_a11.log`, `logs/host_new_tests_a11.log`);
the third pins the plan spec the other two depend on and passes either way, which
