...
from tt_transformers.modules.attention.attention_1d import Attention1DConfig
from tt_transformers.modules.lazy_weight import LazyWeight
from tt_transformers.modules.mlp.mlp_1d import MLP1DConfig
from tt_transformers.modules.rmsnorm.rmsnorm_1d import RMSNorm1DConfig
from tt_transformers.modules.rope.rope_1d import Rope1DConfig, _resolve_rope_config
...
def test_decoder_builder_writes_explicit_recipes_on_common_configs(
    ...
    monkeypatch.setattr(
        "tt_transformers.models.llama33_70b.model._post_attn_norm_decode_configs",
...
def test_paged_attention_mutation_uses_common_block_contract():
    ...
    from tt_transformers.models.llama33_70b.model import Llama33_70BTransformer1D
