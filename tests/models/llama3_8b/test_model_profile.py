...
from tt_transformers.modules.rope.rope_1d import RotarySetup1D
...
def test_transformer_block_consumes_only_common_configs(monkeypatch):
    ...
    monkeypatch.setattr("tt_transformers.models.llama3_8b.model.RMSNorm1D.from_config", rms_from_config)
    monkeypatch.setattr("tt_transformers.models.llama3_8b.model.Attention1D.from_config", attention_from_config)
    monkeypatch.setattr("tt_transformers.models.llama3_8b.model.MLP1D.from_config", mlp_from_config)
