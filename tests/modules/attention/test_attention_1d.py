...
def test_attention_prefill_selects_scalar_or_tensor_chunk_start_api(monkeypatch, use_runtime_tensor):
    ...
    cfg = SimpleNamespace(
        ...
        head_dim=128,
        li_o_prefill_compute_kernel_cfg=arch_cfg.li_o_prefill_compute_kernel_cfg,
        li_qkv_prefill_compute_kernel_cfg=arch_cfg.li_qkv_prefill_compute_kernel_cfg,
        ...
        scale=0.125,
        sdpa_prefill_compute_kernel_cfg=arch_cfg.sdpa_prefill_compute_kernel_cfg,
        sliding_window=None,
...
def _list_test_cases() -> list[pytest.param]:
    ...
    return [
        ...
        # See tests/modules/attention/low_pcc_notes.md for detailed analysis
