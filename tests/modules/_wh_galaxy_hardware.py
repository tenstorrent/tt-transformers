...
from tt_transformers.models.galaxy import GalaxyModePlan, GalaxyResourcesConfig
from tt_transformers.models.galaxy.prefetch import GALAXY_GLOBAL_CB_SIZE, build_galaxy_prefetcher_config
from tt_transformers.models.galaxy.recipes import prefetch_sender_cores
from tt_transformers.modules.prefetcher import Prefetcher2D, Prefetcher2DConfig

_FACTORY_MODULE = "tt_transformers.models.galaxy"
...
#: topology, not of a test. It lives in `tt_transformers.models.galaxy.prefetch`
...
def galaxy_prefetcher_config(
    ...
    *,
    ...
    `tt_transformers.models.galaxy.prefetch`, which owns the 12 real senders, the
...
def galaxy_mode_plan(
    ...
    *,
    ...
    return GalaxyModePlan(
        ...
        # docstring describes; GalaxyModePlan rejects it otherwise.
