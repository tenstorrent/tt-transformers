...
from tt_transformers.sampling.generator import (
    MAX_UINT32,
...
def _make_stub_generator(max_batch_size=SEED_TEST_BATCH):
    from tt_transformers.mesh_utils import Generator
...
@pytest.mark.host
@pytest.mark.skip(reason="legacy TTTv1 Generator seed-state contract is outside standalone ownership")
...
def test_topk_route_mirror_parity(mesh_device, shape, k, expected):
    ...
    from tt_transformers.sampling._utils import topk_would_route_to_large_indices
