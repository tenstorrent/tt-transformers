...
from tt_transformers.modules.sampling.seed_manager_1d import SeedManager1D, SeedState, _hash_request_seed_to_device_seed
...
def test_seed_manager_1d_imports_no_legacy_sampling_state_or_generator():
    module_path = Path(__file__).parents[3] / "src/tt_transformers/modules/sampling/seed_manager_1d.py"
