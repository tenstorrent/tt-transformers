...
# TEST NOTES:
# - 'mesh_device' and 'device_params' come from repo-root 'tests/conftest.py'.
# - 'device_params' defaults to '{}' (no explicit fabric config).
# - 'tests/conftest.py' provides additional common-test fixtures
...
def default_sub_core_grids(mesh_device) -> ttnn.CoreRangeSet:
    ...
    tests/modules/sampling/test_legacy_sampling.py::_single_device_sampling_args. (#38316)
    """
...
# sampling tests in tests/modules/sampling/test_legacy_sampling.py, but that file is not wired into
