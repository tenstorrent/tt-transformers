...
def test_no_persistent_sender_is_dispatched_while_a_trace_capture_is_in_progress(resources):
    ...
    `ttnn.end_trace_capture` in `tttv2_milestone_c_evidence/trace/logs/
    s4_l1_prefill_capture_hang.gdb.txt`. Everything else about the activation is
    unchanged, the stall group included.
    """
