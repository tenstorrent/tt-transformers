...
def test_mlp_1d_config_prefill_override(ttnn_mesh_device: ttnn.MeshDevice):
    ...
    """
    from tt_transformers.modules.mlp.mlp_1d import _find_prefill_grid
...
# [INFO] this test will retire once src/tt_transformers/modules/attention/attention_1d.py retires
@pytest.mark.device
@pytest.mark.parametrize(
    "ttnn_mesh_device",
    [
