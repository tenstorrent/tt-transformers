...
from tt_transformers.modules.rope.rope_2d import RotarySetup2D, RotarySetup2DConfig, prepare_rot_idxs
from tt_transformers.tensor_utils import parse_shard_dims_from_mesh_mapper_config
...
def test_rope_2d_prefill_table_copy_is_tilized_and_decode_table_is_not(monkeypatch):
    ...
    from tt_transformers.modules.rope import rope_2d
