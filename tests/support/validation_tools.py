...
def compare_to_ttnn(
    ...
    *,
    input_to_ttnn: Callable | None = None,
    output_to_ttnn: Callable | None = None,
    metric_tolerances: dict[Any, Any] | None = None,
    enabled: bool = True,
    ...
    def map_fn_to_match_sig(tt_tensor, filler):
        return to_torch_auto_compose(tt_tensor)
...
def compare_to_torch(
    reference_fn: Callable,
    *,
    input_to_torch: Callable | None = None,
    output_to_torch: Callable | None = None,
    metric_tolerances: dict[Any, Any] | None = None,
    enabled: bool = True,
    raise_exceptions: bool = False,
    return_reference_output: Callable[..., bool] | bool | None = False,
):
    """
...
def __validate_against(
    reference_fn: Callable,
    *,
    input_map: Callable | None = None,
    output_map: Callable | None = None,
    metric_tolerances: dict[Any, Any] | None = None,
    enabled: bool = True,
    raise_exceptions: bool = False,
    reference_output_map_fn: Callable | None = None,
):
    """
