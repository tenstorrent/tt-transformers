...
| [E01](E01-wh-byte-identical/) | Is Wormhole decode byte-identical after the phase-2 refactor? | whether the topology descriptor may keep the qualified path | **WH** Galaxy | procedure | **not run** |
