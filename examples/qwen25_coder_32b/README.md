...
MESH_DEVICE=T3K python -m examples.qwen25_coder_32b.demo \
...
```bash
HF_HOME=/path/to/hf-cache HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 MESH_DEVICE=T3K HF_MODEL=Qwen/Qwen2.5-Coder-32B-Instruct python -m examples.qwen25_coder_32b.benchmark --case token-accuracy --optimizations performance
```
