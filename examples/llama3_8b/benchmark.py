...
# sweep. T3K batch-1 TTFT uses comparable
...
def run_llama3_8b(test_config, ttnn_mesh_device, optimizations):
...
def run_llama3_8b_bh_seeded_cross_cardinality(ttnn_mesh_device, optimizations):
