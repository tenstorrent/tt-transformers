...
- Reference asset root: `qualification/assets/reference_outputs/qwen2_7b`.
...
```bash
HF_HOME=/path/to/hf-cache HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 MESH_DEVICE=N300 HF_MODEL=Qwen/Qwen2-7B-Instruct python -m examples.qwen2_7b.demo --case token-accuracy --optimizations performance
```
