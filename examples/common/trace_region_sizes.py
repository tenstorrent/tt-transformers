...
``examples/config/model_trace_region_sizes.yaml``, keyed by model and SKU (the
...
from examples.common.model_targets import _model_matches, normalize_sku

TRACE_REGION_SIZES_YAML_PATH = Path(__file__).resolve().parents[1] / "config/model_trace_region_sizes.yaml"
