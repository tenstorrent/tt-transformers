...
Milestone C findings only became legible because the same measurement was taken on both.
...
- Milestone C did not pass on performance. Both of this model's paired decode gates failed, as did
  its TTFT gate; teacher-forced accuracy through the executor was 97.46 % top-1 and 100.00 % top-5,
  but not in the performance configuration. That investigation was deliberately left behind rather
  than ported mid-flight.
