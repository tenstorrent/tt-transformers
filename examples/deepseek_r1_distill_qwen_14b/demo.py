...
"""Generate text with the public deepseek_r1_distill_qwen_14b model API."""
...
from tt_transformers.models.deepseek_r1_distill_qwen_14b.hf_generator import DEFAULT_HF_MODEL, from_pretrained
