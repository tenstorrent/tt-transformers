...
# this session; the on_device_topk bucket is the TTTv1-comparable path.
# =============================================================================
...
# batch-1 throughput, sampling-mode- and profile-aware (values from the 2026-07-23 FF-pad matrix).
# Per the parity rule the DECODE tok_s_u gate = best-of(TTTv1_default, TTTv2_odt); the ttft_ms gate is a
# conservative single-user ceiling (b1 TTFT is bimodal/noisy — NOT a tight parity gate). On T3K TTTv1 samples ON-DEVICE and after the FF-hidden DRAM-shard pad
...
# TTTv1 ci-32 analog (the matched CI pair). Per the parity rule: on_device_topk gate = best-of(TTTv1 ci-32,
...
# tracked separately and is NOT a tight demo gate.
...
def run_deepseek_r1_qwen_14b(test_config, mesh_device, optimizations):
