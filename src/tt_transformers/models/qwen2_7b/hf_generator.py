...
"""Hugging Face generation and loading for the TTTv2 Qwen2-7B path."""
...
from tt_transformers.models.qwen2_7b.model import (
    QWEN2_7B_ACCURACY,
...
from tt_transformers.models.qwen2_executor import Qwen2Executor, Qwen2ExecutorConfig
from tt_transformers.models.qwen2_executor import build_qwen2_7b_executor as _build_qwen2_7b_executor

DEFAULT_HF_MODEL = "Qwen/Qwen2-7B-Instruct"
DEFAULT_HF_REVISION = "f2826a00ceef68f0f2b946d945ecc0477ce4450c"
...
def from_pretrained(
    ...
    *,
    ...
    paged_attention_config: Qwen2PagedAttentionConfig | None = None,
    cache_dir: Path | str | None = None,
    executor_config: Qwen2ExecutorConfig | None = None,
) -> Qwen2ForCausalLM:
    ...
    the existing ``Qwen2ExecutorConfig`` for explicit trace/sampling policy.
    """
    if executor_config is not None and not isinstance(executor_config, Qwen2ExecutorConfig):
        raise TypeError("executor_config must be a Qwen2ExecutorConfig")
    ...
    if paged_attention_config is None:
        ...
        paged_attention_config = Qwen2PagedAttentionConfig(block_size=block_size, max_num_blocks=max_num_blocks)
    if executor_config is not None:
    ...
    try:
        ...
        llm.executor = build_qwen2_7b_executor(llm, executor_config)
        try:
