...
from tt_transformers.models.qwen3_32b_galaxy import weight_utils
...
def from_pretrained(
    ...
    *,
    ...
    cache_path = _cache_path(hf_model, mesh_device, cache_dir, hf_revision=hf_revision, dtype=precision.kv_cache_dtype)
