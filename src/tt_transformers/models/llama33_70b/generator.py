...
"""vLLM construction and compatibility delegation for Llama 3.3-70B."""
...
from tt_transformers.models.llama33_70b.executor import Llama33_70BExecutorConfig, build_llama33_70b_executor
from tt_transformers.models.llama33_70b.hf_adaptor import from_pretrained
from tt_transformers.models.llama33_70b.model import Llama33_70BPagedAttentionConfig
...
class Llama33_70BGenerator:
    ...
    delegated to ``Llama33_70BExecutor`` or ``LaneGroupExecutor``.
    ...
    def initialize_vllm_model(
        ...
        return build_llama33_70b_generator(
...
def build_llama33_70b_generator(config: Llama33_70BGeneratorConfig) -> Llama33_70BGenerator:
    ...
    try:
        for submesh in submeshes:
            ...
            lanes.append(build_llama33_70b_executor(llm, executor_config))
    ...
    return Llama33_70BGenerator(target, adapter)
...
def _model_kv_metadata(model) -> tuple[tuple[Any, ...], int, int, int]:
    ...
    if not layers:
        raise ValueError("Llama 3.3-70B model must contain at least one attention layer")
