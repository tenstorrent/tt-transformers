...
def build_galaxy_decode_collectives(
    ...
    *,
    ...
    lm_head_all_reduce = GalaxyCollectivePlan(
        ...
        #   * `logs/p6_L80_replay_divergence_localiser.log` and `p7`: every decode
        ...
        #   * `logs/p8_L80_lm_head_hoist_headroom120.log`: with the buffer
        ...
        # `logs/p4_L80_baseline_l1_map.log` measures the decode graph's own demand
        # on that reserve at 55 648 B of the 65 536 `GALAXY_GLOBAL_CB_HEADROOM`
