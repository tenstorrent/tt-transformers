...
"""Hugging Face generation and loading for the TTTv2 Llama-3.2-1B path."""
...
from tt_transformers.models.llama32_1b.model import (
    LLAMA32_1B_ACCURACY,
...
DEFAULT_HF_REVISION = "9213176726f574b556790deb65791e0c5aa438b6"
...
def from_pretrained(
    ...
    *,
    ...
    paged_attention_config: Llama32_1BPagedAttentionConfig | None = None,
    cache_dir: Path | str | None = None,
    executor_config: Llama32_1BExecutorConfig | None = None,
) -> Llama32_1BForCausalLM:
    ...
    the existing ``Llama32_1BExecutorConfig`` for explicit trace/sampling policy.
    """
    if executor_config is not None and not isinstance(executor_config, Llama32_1BExecutorConfig):
        raise TypeError("executor_config must be a Llama32_1BExecutorConfig")
    ...
    try:
        ...
        llm.executor = build_llama32_1b_executor(llm, executor_config)
        try:
