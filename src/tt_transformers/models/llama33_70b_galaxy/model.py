    ...
    *,
    ...
    sampling_config = (
        Sampling2DConfig(
            ...
            # every device is handed all 32 users. That is D-C23: the sampler's
            ...
            # sub-device 0 and lose their ordering against `topk` (D-C12).
...
class Llama33_70BGalaxyTransformer2D(LightweightModule):
    ...
    def project_prefill_logits(
        ...
        *,
        ...
        (`tttv2_milestone_c_evidence/trace/logs/a1_L_decode32.log`, thread 1 in
