...
"""Hugging Face generation and loading for Qwen2.5-72B-Instruct."""
...
from tt_transformers.models.qwen2_executor import Qwen25_72BExecutor, Qwen25_72BExecutorConfig
from tt_transformers.models.qwen2_executor import build_qwen25_72b_executor as _build_qwen25_72b_executor
from tt_transformers.models.qwen25_72b import weight_utils
from tt_transformers.models.qwen25_72b.model import (
    DEFAULT_HF_REVISION,
    QWEN25_72B_ACCURACY,
...
def from_pretrained(
    ...
    *,
    ...
    paged_attention_config: Qwen25_72BPagedAttentionConfig | None = None,
    cache_dir: Path | str | None = None,
    executor_config: Qwen25_72BExecutorConfig | None = None,
) -> Qwen25_72BForCausalLM:
    ...
    the existing ``Qwen25_72BExecutorConfig`` for explicit trace/sampling policy.
    """
    if executor_config is not None and not isinstance(executor_config, Qwen25_72BExecutorConfig):
        raise TypeError("executor_config must be a Qwen25_72BExecutorConfig")
    ...
    if paged_attention_config is None:
        ...
        paged_attention_config = Qwen25_72BPagedAttentionConfig(block_size=block_size, max_num_blocks=max_num_blocks)
    if executor_config is not None:
    ...
    try:
        if executor_config is None:
            executor_config = Qwen25_72BExecutorConfig(
        ...
        llm.executor = build_qwen25_72b_executor(llm, executor_config)
        try:
