...
in :mod:`tt_transformers.models.qwen25_7b.hf_generator`.
"""
...
class Qwen25_7BPrecisionConfig:
    ...
    # broadens per-layer divergence on this model, measured against the
    # Hugging Face reference per layer.
...
def _qwen_wh_attn_hifi4_kernel() -> ttnn.WormholeComputeKernelConfig:
    ...
    Qwen2.5-7B (retained from the legacy tt-metal model policy).
