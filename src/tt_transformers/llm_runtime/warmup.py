    ...
    def warmup_decode(
        ...
        *,
        ...
        for case in plan.decode:
            ...
            # `finally: resources.synchronize("decode")`, and never returns. The
            # stack was captured by a repeating `faulthandler` dump.
            #
            ...
            # every result measured so far. Prefill deliberately does not
