...
from tt_transformers.llm_runtime.prefill.plan import PrefillChunk
from tt_transformers.llm_runtime.prefill.postprocess import (
    KPTSignature,
    PrefillPostprocessor,
    new_logprob_output,
    without_borrowed,
)
from tt_transformers.llm_runtime.prefill.result_collector import InvocationResult
...
class PrefillTraceLifecycle:
    ...
    def refresh(
        ...
        # finish_regular_prefill), so their position inputs must follow the prompt on every
        # replay. Ported from tenstorrent/tt-metal#55343.
