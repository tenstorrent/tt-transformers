...
Key design:
  ...
  - callers select distributed prefill explicitly through RMSNorm1DConfig
"""
...
def _derive_rmsnorm_mesh_device(config: RMSNorm1DConfig) -> ttnn.MeshDevice:
    ...
    if mesh_device is None:
        mesh_device = compatibility_default_device(ttnn, owner="modules.rmsnorm._derive_rmsnorm_mesh_device")
    if mesh_device is None:
