...
Weight format requirements:
  ...
  implementation. Convert HF weights in model-owned weight conversion code before
  passing them to Attention1D.

  When using direct construction or `from_config` with weights extracted from
  HuggingFace models, apply this transformation before constructing Attention1D.
"""
...
class Attention1DConfig:
    ...
    #
    # kv_cache options:
    # - None: Set externally before forward via direct assignment
