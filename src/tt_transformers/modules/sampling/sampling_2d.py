...
class Sampling2DConfig:
    ...
    #: the one this executor path needs, and D-C23 is that it had no expression
    ...
    #: See D-C12. Callable, not a value: the id belongs to the live
    #: operation-boundary context, which is created after this config.
    ...
    def decode_forward(
        ...
        *,
        ...
        try:
            ...
            #
            # That is D-C22. Flattening the input once, here, puts every
            ...
            # (`tttv2_milestone_c_evidence/trace/logs/p1_L_sampling_context.log`,
            # arms A-G).
            #
