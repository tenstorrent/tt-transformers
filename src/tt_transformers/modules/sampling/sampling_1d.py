...
class Sampling1D(LightweightModule):
    ...
    def load_device_buffers(self):
        ...
        try:
            ...
            from tt_transformers.sampling.logprobs import LogProbsCalculator  # lazy: transitively imports torch
...
def _resolve_sampling1d_config(config: Sampling1DConfig) -> Sampling1DConfig:
    ...
    mesh_device = config.mesh_device or compatibility_default_device(
        ttnn, owner="modules.sampling._resolve_sampling1d_config"
    )
