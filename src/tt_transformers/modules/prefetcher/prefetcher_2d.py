...
class Prefetcher2D:
        ...
        try:
            ...
            if mode == "decode":
                ...
                if self._sender_launch_site == "graph":
                    ...
                    # can never be reached, which is the hang
                    # `logs/s4_l1_prefill_capture_hang.gdb.txt` caught inside
    ...
    def set_sender_launch_site(self, site: str) -> None:
        ...
        The default is unchanged, so `GalaxyDirectRunner` and every Milestone A
        and B caller behaves byte for byte as before.
        """
