...
``qualification/manifests/model_trace_region_sizes.yaml``, keyed by model and SKU (the
...
from qualification.tools.model_targets import _model_matches, normalize_sku

TRACE_REGION_SIZES_YAML_PATH = Path(__file__).resolve().parents[1] / "manifests/model_trace_region_sizes.yaml"
