...
_REQUIRED_CONTRACT_IDENTITIES = {
    "tttv2_llama3_8b_bh_required_capabilities_v1": {
        ...
        "demo_entry_point": "tests/hardware/models/llama3_8b/test_demo.py",
    },
    "tttv2_qwen3_32b_bh_required_capabilities_v1": {
        "package": "qwen3_32b",
        "hf_model_id": "Qwen/Qwen3-32B",
        "demo_entry_point": "tests/hardware/models/qwen3_32b/test_demo.py",
    },
    "tttv2_llama33_70b_bh_required_capabilities_v1": {
        "package": "llama33_70b",
        "hf_model_id": "meta-llama/Llama-3.3-70B-Instruct",
        "demo_entry_point": "tests/hardware/models/llama33_70b/test_demo.py",
    },
}
...
_QWEN_DEMO_MANIFEST = {
    "p150x4.performance.token_accuracy": (
        ...
        "token-accuracy",
        "token-accuracy",
        "tests/hardware/models/qwen3_32b/test_demo.py::test_qwen3_32b[performance-token-accuracy-P150x4]",
    ),
    "p150x4.accuracy.token_accuracy": (
        "accuracy",
        "token-accuracy",
        "token-accuracy",
        "tests/hardware/models/qwen3_32b/test_demo.py::test_qwen3_32b[accuracy-token-accuracy-P150x4]",
    ),
    "p150x4.performance.eval_32": (
        "performance",
        "eval-32",
        "eval-32",
        "tests/hardware/models/qwen3_32b/test_demo.py::test_qwen3_32b[performance-eval-32-P150x4]",
    ),
    "p150x4.accuracy.eval_32": (
        "accuracy",
        "eval-32",
        "eval-32",
        "tests/hardware/models/qwen3_32b/test_demo.py::test_qwen3_32b[accuracy-eval-32-P150x4]",
    ),
    "p150x4.performance.eval_32_perf_report": (
        "performance",
        "eval-32-perf-report",
        "eval-32-perf-report",
        "tests/hardware/models/qwen3_32b/test_demo.py::test_qwen3_32b[performance-eval-32-perf-report-P150x4]",
    ),
    "p150x4.accuracy.eval_32_perf_report": (
        "accuracy",
        "eval-32-perf-report",
        "eval-32-perf-report",
        "tests/hardware/models/qwen3_32b/test_demo.py::test_qwen3_32b[accuracy-eval-32-perf-report-P150x4]",
    ),
    "p150x4.performance.batch_32_ci": (
        "performance",
        "batch-32-ci",
        "batch-32-ci",
        "tests/hardware/models/qwen3_32b/test_demo.py::test_qwen3_32b[performance-batch-32-ci-P150x4]",
    ),
    "p150x4.accuracy.batch_32_ci": (
        "accuracy",
        "batch-32-ci",
        "batch-32-ci",
        "tests/hardware/models/qwen3_32b/test_demo.py::test_qwen3_32b[accuracy-batch-32-ci-P150x4]",
    ),
    "p150x4.accuracy.seeded_cross_cardinality": (
        "accuracy",
...
def _demo_source_errors(contract: Mapping[str, Any]) -> list[str]:
    ...
    source_path = REPOSITORY_ROOT / entry_point
