...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--revision",
        default=None,
        help="HF revision pin (defaults to the value recorded in src/tt_transformers/models/qwen25_72b/model.py)",
    )
    return parser
...
def main() -> None:
    ...
    if revision is None:
        from tt_transformers.models.qwen25_72b.model import DEFAULT_HF_REVISION
