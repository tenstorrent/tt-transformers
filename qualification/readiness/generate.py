...
CLI:
    python -m qualification.readiness.generate \\
...
Python:
    from qualification.readiness.generate import generate_reference
    generate_reference(
...
from qualification.readiness.schema import Reference, ReferenceEntry, save_reference
