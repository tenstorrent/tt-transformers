...
CLI:
    python -m qualification.readiness.run_prefill_check \\
...
from qualification.readiness.mesh_device import (
    add_mesh_device_args,
    close_readiness_mesh_device,
    open_readiness_mesh_device,
)
from qualification.readiness.schema import Reference, ReferenceEntry, load_reference
...
def _import_build_generator(model_dir: Path) -> BuildGeneratorFn:
    ...
    if fn is None or not callable(fn):
        raise AttributeError(
            ...
            f"See qualification/readiness/contract.py."
        )
