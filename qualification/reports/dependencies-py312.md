# Dependency-group qualification — CPython 3.12.13

Status: **passed for the refreshed isolated dependency groups and imports**

Machine-readable evidence: `qualification/reports/dependencies-py312.json`

## Verdict

The current base, examples, and test groups resolve together in the existing
isolated CPython 3.12.13 venv. `pip check` reports no broken
...
|---|---|
| Python | `3.12.13` |
| Venv | `/tmp/gwang/tttv2-deps-py312.yi8BCf/venv` |
...
|---|---|---|---|
| `ttnn` | `0.77.0` | `cp312-cp312-manylinux_2_34_x86_64` | `ttnn` |
| `torch` | `2.11.0+cpu` | `cp312-cp312-manylinux_2_28_x86_64` | `torch` |
...
## Exact transitive freeze (62 distributions)
...
```bash
PYTHON=/tmp/gwang/uv-python/cpython-3.12.13-linux-x86_64-gnu/bin/python3.12
QUAL_DIR=/tmp/gwang/tttv2-deps-py312.yi8BCf
